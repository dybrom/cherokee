    ...
    public class InMemoryManager
    {
        public List<InMemoryUser> GetUsers()
        {
            return new List<InMemoryUser>
            {
                ...
                {
                    Subject = "Saninre",
                    Username = "saninredz@gmail.com",
                    Password = "doktor",
                    Claims = new[]
                    {
                        new Claim(Constants.ClaimTypes.Name, "Sanin Redzepovic")
                    }
                },
                new InMemoryUser
                {
                    Subject = "Arif",
                    Username = "arifmahmic@gmail.com",
                    Password = "nekipassword",
                    Claims = new[]
                    {
                        new Claim(Constants.ClaimTypes.Name, "Arif Mahmic")
                    }
                },
